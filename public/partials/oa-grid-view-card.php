...
<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 text-center my-5 p-4">

  <!--  image -->
  <div class="text-center">
    <a href="<?php echo $link;?>/">
      <img class="oa-grid-image" src="<?php echo $image;?>" alt="<?php echo $name; ?>" />
    </a>
  </div>
  ...
  <div class="order-2 flex-fill">
    <div>
      <div class="obit_name lh-l oa-grid-name">
        <a class="text-decoration-none" href="<?php echo $link; ?>/"><?php echo '<h3 class="my-3">' . $name . '</h3>'; ?></a>
      </div>
      <div class="oa-grid-date">
  ...
  <div class="row mb-4">
    <div class="col">
      <div class="col text-center">
        <a href="<?php echo $link; ?>/" role="button" class="btn border rounded" title="<?php echo $detail; ?>">
          <?php echo $detail; ?>
        </a>
      </div>
    </div>
  ...
  <div class="row">
    ...
    <?php if ($flowers_only_button != "" || $extra_buttons != ""){ ?>
      <div class="col text-center">
        <a href="<?php echo $link; ?>/?show_flowers=1" role="button" class="btn border rounded" title="Send Flowers">
    ...
    <?php } if ($trees_only_button != "" || $extra_buttons != "") { ?>
      <div class="col text-center">
        <a href="<?php echo $link; ?>/?show_trees=1" role="button" class="btn border rounded" title="Plant Trees">
